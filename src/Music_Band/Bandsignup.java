...
public class Bandsignup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bRePWD = new javax.swing.JPasswordField();
        ...
        bSignup.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(221, 221, 221)
                .addComponent(bSignup, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(115, 115, 115)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel7)
                    .addComponent(bRePWD, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(71, 71, 71)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(bSignup, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSignupActionPerformed
            ...
            String bre_pass = String.valueOf(bRePWD.getPassword());
            ...
            else if(bpass.equals(""))
            {
                JOptionPane.showMessageDialog(null, "Add A Password");
            }
            else if(!bpass.equals(bre_pass))
            {
                JOptionPane.showMessageDialog(null, "Retype The Password Again");
            }

            else if(checkUsername(buname))
            {
                ...
                String query = "INSERT INTO `bandregister`(`bName`, `bType`, `bUName`, `bPWD`, `bPNo`, `bEmail`, `bLocation`, `bMembers`, `bBio`, `bCharge`)VALUES (?,?,?,?,?,?,?,?,?,?)";
         ...
         public boolean checkUsername(String username)
    {
        ...
        String query = "SELECT * FROM `bandregister` WHERE `bUName` =?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bandsignup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bandsignup().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPasswordField bRePWD;
    public javax.swing.JButton bSignup;
