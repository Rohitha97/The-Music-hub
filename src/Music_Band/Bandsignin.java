 ...
 * @author RwB - Pc
 */
public class Bandsignin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bUserName.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N

        cancel3.setBackground(new java.awt.Color(255, 0, 0));
        cancel3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        cancel3.setForeground(new java.awt.Color(255, 255, 255));
        cancel3.setText("CANCEL");
        cancel3.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        bSignin.setBackground(new java.awt.Color(255, 0, 0));
        bSignin.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        bSignin.setForeground(new java.awt.Color(255, 255, 255));
        bSignin.setText("SIGN IN");
        bSignin.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(bSignin, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(90, 90, 90)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(bUserName, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE)
                            .addComponent(bPWD))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(bPWD, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(93, 93, 93)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bSignin, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bSigninActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSigninActionPerformed
        ...
        ResultSet rs;
        String buname = bUserName.getText();
        String bpass = String.valueOf(bPWD.getPassword());
        
        String query = "SELECT * FROM `bandregister` WHERE `bUName` =? AND `bPWD` =?";
        
        try {
            ps = DBconnection.getConnection().prepareStatement(query); 
            
            ps.setString(1, buname);
            ...
            { 
                    ...
                    bandInFace aw = new bandInFace();              
                    aw.setVisible(true);
                    aw.pack();
                    aw.setLocationRelativeTo(null);
                    aw.wLabel.setText(" "+buname+" ");     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bandsignin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bandsignin().setVisible(true);
            }
        });
    }
